...
- **Logic:**
  - `OI` → First 2 letters of Company (e.g., Odoo India)
...
│   │   ├── pages/           # Login, Signup (Admin), Dashboard
│   │   ├── index.css        # Global variables (RGB Colors)
│   │   └── api.js           # Axios instance
├── server/                  # Node.js Backend
│   ├── config/
│   │   └── db.js            # MySQL Connection (mysql2 pool)
│   ├── routes/
│   │   └── auth.js          # Logic for ID Generation & Login
